...
const DATABASES = {
  ...
  assumptions: process.env.NOTION_DB_ASSUMPTIONS,
};
...
const tools: Tool[] = [
  ...
  // ============ RAW NOTION ACCESS ============
  {
    ...
    inputSchema: {
      type: "object" as const,
      properties: {
        database: { type: "string", description: "Database name: 'tasks', 'orders', 'essentials', 'documents', 'metrics', 'goals', 'feedback', 'recurringTasks', 'sales', 'webAnalytics', 'assumptions'" },
